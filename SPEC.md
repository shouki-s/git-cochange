...
| 2026-04-18 | 大規模コミット | 現状何もしない。問題が出た場合は N ファイル超コミットを除外する前処理で対応（スコア式は変更しない）。 |
| 2026-04-18 | リネーム/移動 | 追跡しない。現在のパスの履歴のみ対象。 |
| 2026-04-18 | 削除済みファイル | 含めない。getFiles() は現存ファイルのみ。 |
| 2026-04-18 | キャッシュ | 現スコープ外。将来フェーズで必ず実装。現状はメモリ保持のみ。 |
| 2026-04-18 | パフォーマンス目標 | 数値目標なし。対象規模は Linux カーネル相当（~100万コミット、~8万ファイル）。 |
